...
export const USER_OPERATION_IDS = [
  ...
  "discord.requester.pull.active",
  "discord.requester.pull.reserved-source",
  "discord.requester.pull.navigate",
...
> = {
  ...
  "twitch.queue.expired-receipts": [1_000],
  ...
  "discord.requester.postpone.closed-follow-ups": [1_000],
...
> = {
  ...
  "discord.requester.postpone.closed-follow-ups": { warmups: 0, samples: 1 },
...
export const OPERATION_FAMILY_BY_ID: Readonly<Record<UserOperationId, BenchmarkOperationFamily>> = {
  ...
  "twitch.queue.expired-receipts": "maintenance:receipts",
  ...
  "discord.requester.pull.active": "raid:pull-requester",
  "discord.requester.pull.reserved-source": "raid:pull-requester",
  "discord.requester.pull.navigate": "raid:pull-requester",
  ...
  "discord.requester.postpone.closed-follow-ups": "raid:removed-history",
