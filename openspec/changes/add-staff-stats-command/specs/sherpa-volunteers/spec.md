...
The configured Discord role SHALL determine who can operate the staff board, view staff statistics and the staff user directory, and be selected as a volunteer leader. The configured streamer SHALL also be authorized for the board, statistics, and user directory. The system SHALL NOT store volunteer profiles.
...
- **WHEN** the configured streamer or a current volunteer-role member invokes `/users`
