...
- [ ] 5.5 Deploy the verified change to the development environment and smoke-test an automatically grouped review with no calls, a pre-call requester correction, streamer-led start, volunteer-led start, reserved-leader restriction, and compatibility with an existing active detail message.
