      ...
      return {
        ...
        miniflare: {
          ...
          bindings: {
            ...
            PRE_0006_MIGRATIONS: migrations.slice(0, -4),
            MIGRATION_0006: migrations.slice(-4, -3),
            PRE_0007_MIGRATIONS: migrations.slice(0, -3),
            MIGRATION_0007: migrations.slice(-3, -2),
            PRE_0008_MIGRATIONS: migrations.slice(0, -2),
            MIGRATION_0008: migrations.slice(-2, -1),
            PRE_0009_MIGRATIONS: migrations.slice(0, -1),
            MIGRATION_0009: migrations.slice(-1),
